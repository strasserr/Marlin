...
#define STRING_CONFIG_H_AUTHOR "(Rudi, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PARINTER"
...
#define ST7920_DELAY_1 DELAY_NS(83)
#define ST7920_DELAY_2 DELAY_NS(120)
#define ST7920_DELAY_3 DELAY_NS(145)
